...
ref = cv2.threshold(ref, 20, 255, cv2.THRESH_BINARY)[1]
...
cv2.drawContours(image,contours,2,(255,255,0),1)
...
"""
#imgCnts = cv2.findContours(img.copy(), cv2.RETR_EXTERNAL,
	#cv2.CHAIN_APPROX_NONE)
#imgCnts = imgCnts[0] if imutils.is_cv2() else imgCnts[1]
