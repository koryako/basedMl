...
def save_bottlebeck_features():
    ...
    model = Sequential()
    model.add(ZeroPadding2D((1, 1), input_shape=(img_width,img_height,3)))#tensorflow写法
    #model.add(ZeroPadding2D((1, 1), input_shape=(3, img_width, img_height))) # theano的写法，
